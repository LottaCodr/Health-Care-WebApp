            ...
            <header className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                    <div className="flex items-center gap-2 text-gray-950">
                        ...
                        <h1 className="truncate text-lg font-black sm:text-xl">Appointment booking</h1>
                    </div>
                    <p className="mt-0.5 text-xs text-gray-500">Schedule, confirm, check in, or reschedule patient visits.</p>
                </div>
            </header>
