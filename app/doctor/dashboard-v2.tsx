                ...
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">Welcome, Dr. {user?.name || "Doctor"}</p>
                        </div>
                        <div className="text-right">
                            <p className="text-sm text-gray-600">License: {user?.licenseNumber || "N/A"}</p>
                            <p className="text-sm text-gray-600">Department: {user?.department || "General"}</p>
                        </div>
                    </div>
                </div>
            </div>
