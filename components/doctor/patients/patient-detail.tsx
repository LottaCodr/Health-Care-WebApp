    ...
    try {
      ...
      if (role === "nurse") {
        ...
        toast({
          ...
          description: "The selected staff member is not eligible for this task. Only Nurse, Pharmacist, or Lab Tech can be assigned. Please select a staff member with an appropriate role.",
          duration: 7000,
        });
        return;
      }
      ...
      toast({
        variant: "default",
        title: "Success",
        description: `Consultation and task have been successfully assigned to ${selectedStaff?.name || "staff member"}. You can view the updated status in the patient’s record.`,
        duration: 5000,
      });
...
const profileFields = [
  ...
  // Removed: currentMedication: row.current_medication,
  {
...
function PatientProfile({
  ...
  // Prioritize $id as Patient ID, fallback to id if not present
  const patientData: Record<string, any> = {
    ...patient,
    status,
    notes: patient?.notes || "No note yet",
    $id: (patient as any).userId || (patient as any).id || "",
  };
        ...
        <CardContent>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
              {renderInfo(
                ...
                (val: any, onCopyId?: () => void, showCopied?: boolean) => {
                  ...
                  if (idField && typeof idField.render === "function") {
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
              ...
              {renderInfo(
                ...
                <MdLocationOn className="text-green-600" />,
                patientData.emergencyContactAddress
              )}
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
              {renderInfo(
                "Allergies",
                <MdMedicalServices className="text-red-600" />,
              ...
              {renderInfo(
                ...
                patientData.significantMedicationHistory
              )}
              {renderInfo(
                "Long Term Medication",
                <FaUserMd className="text-blue-700" />,
                patientData.longTermMedication
              )}
              {renderInfo(
                "Covid Vaccination",
                <MdCheckCircle className="text-green-600" />,
                patientData.covidVaccinationOptions
              )}
              {renderInfo(
                "Blood Group",
                <MdAssignment className="text-blue-700" />,
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3">
              ...
              {renderInfo(
                "Private Client",
                <MdAssignment className="text-blue-700" />,
                patientData.privateClient ? "Yes" : "No"
              )}
            </div>
          </div>
