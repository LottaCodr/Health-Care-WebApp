      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            name="email"
            label="Email"
            placeholder="Lottanna47@gmail.com"
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          ...
          <CustomFormField
            ...
            renderSkeleton={(field) => (
              <FormControl>
                <RadioGroup
                  className="flex h-11 gap-6 xl:jsutify-between"
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            name="address"
            label="Address"
            placeholder="Life Camp, Efab Estate"
          />
