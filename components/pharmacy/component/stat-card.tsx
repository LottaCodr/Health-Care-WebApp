...
export default function PharmacistStatCardsSection() {
    ...
    const statCards: StatCardData[] = [
        {
            ...
            comparison: 'Total patients you have given prescription',
        },
        {
            type: 'staff',
            icon: (
            ...
            label: 'Sent from Doctor',
            count: statistics.labReports,
            comparison: statistics.labReports > 0
                ? `${statistics.labReports > 1 ? '' : ' is'} New arrivals awaiting prescription`
                : 'New arrivals under your care',
        },
        {
            type: 'waiting',
            icon: (
        ...
        },
        {
            ...
            comparison: 'Patients successfully treated this week',
        },
    ];
